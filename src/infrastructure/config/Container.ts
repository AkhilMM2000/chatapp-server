...
import { RedisRateLimitRepository } from "@infrastructure/repositories/RedisRateLimitRepository";
...
import { RedisPresenceRepository } from "@infrastructure/repositories/RedisPresenceRepository";
...
container.registerSingleton<IPresenceRepository>(TOKENS.IPresenceRepository, RedisPresenceRepository);
container.registerSingleton<IMediaService>(TOKENS.IMediaService, S3MediaService);
container.registerSingleton<IRateLimitRepository>(TOKENS.IRateLimitRepository, RedisRateLimitRepository);

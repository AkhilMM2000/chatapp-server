...
router
  .post("/register", authRateLimiter, validate(RegisterSchema), catchAsync(userController.register.bind(userController)))
  ...
  .post("/login", authRateLimiter, validate(LoginSchema), catchAsync(userController.login.bind(userController)))
